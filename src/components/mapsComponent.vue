...
import { useMapStore } from "@/stores/storeMapComponent/index.js";
...
const initMap = async () => {
    try {
        ...
        const { LatLng, InfoWindow } = await google.value.maps.importLibrary("core");
        ...
        marketInit.value = new Marker({ position: origin, 
                                        title: 'asdas', 
