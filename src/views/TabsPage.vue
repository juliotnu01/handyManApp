  ...
  <ion-page>
    <ion-menu menu-id="first-menu" side="end" content-id="main-content">
      <ion-header class="shadow-none bg-[rgb(15,23,18)] text-[rgb(247,247,250)] font-bold h-40 grid grid-rows-3 gap-4  ">
        <div class="p-2">
          <div class=" flex justify-between">
            <ion-menu-toggle>
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.2854 12.0002L11.2727 12.0002" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16.5101 15.6364L19.9999 12L16.5101 8.36363" stroke="#fff" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M13.4545 7V4H4V20H13.4545V17" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </ion-menu-toggle>
            <div>
              <p class=" self-center tracking-wide text-sm font-bold text-[rgb(247,247,250)]">Detached house • 5y old</p>
              <p class="text-[#cecece] text-end text-[12px]">742 Evergreen Terrace</p>
            </div>
          </div>
          <div class="flex justify-between mt-4 ">
            <p class="text-3xl  text-[rgb(247,247,250)] font-bold  ">
              $750,000
            </p>
            <svg class=" self-center " width="30px" height="30px" viewBox="0 0 24 24" fill="none"
          ...
          <div class="flex justify-around mt-4 gap-2">
            <button class="bg-white text-black px-3 rounded-xl py-1 text-[12px] flex justify-between gap-2">
              ...
              <p class="self-center"> Solicitar Servicio </p>
            </button>
            <button class="bg-white text-black px-3 rounded-xl py-1 text-[12px] flex justify-between gap-2">
              <svg class="self-center" width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              <p class="self-center"> Contactar </p>
            </button>
          </div>
        </div>
      </ion-header>
      <ion-content class="">
        <swiper  >
          <swiper-slide >
            <ion-img src="https://imagenes.elpais.com/resizer/32VwWeT2DQmDmJSStO-9TaQw-RQ=/1960x1470/filters:focal(4225x2895:4235x2905)/cloudfront-eu-central-1.images.arcpublishing.com/prisa/VMP7D7JF2BFKPLHOBL3WDBPNZY.jpg"
              alt="The Wisconsin State Capitol building in Madison, WI at night">
            </ion-img>
          </swiper-slide>
          <swiper-slide>
            <ion-img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRxWh_5ue2G7qEpZG_xpnXjx3T5mMiaM_6Vaq7hSrum3QP1JC9SAlKfK5Dvt-pN9ke8c8&usqp=CAU"
              alt="The Wisconsin State Capitol building in Madison, WI at night">
            </ion-img>
          </swiper-slide>
          <swiper-slide>
            <ion-img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkyJuaSN85ls2qiD4f55qZkmJMbMPed0CXFA&usqp=CAU"
              alt="The Wisconsin State Capitol building in Madison, WI at night">
            </ion-img>
          </swiper-slide>
          <swiper-slide >
    ...
    :space-between="5" >
        ...
        <div class="p-1 flex flex-col shadow-2xl mx-1 ">
          <p class="text-justify border-[#cecece]  border-b-[1px]" >
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor suscipit voluptatem soluta aliquid numquam. Soluta corrupti, autem rem repellat placeat sint cumque neque voluptates quis nihil ex tenetur facere possimus.
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor suscipit voluptatem soluta aliquid numquam. Soluta corrupti, autem rem repellat placeat sint cumque neque voluptates quis nihil ex tenetur facere possimus.
          </p>
          <p class="text-justify border-[#cecece]  border-b-[1px] mt-2" >
            <p class=" underline font-bold " >Categoria</p>
            <p class="ml-6" >Reparación</p>
          </p>
          <p class="text-justify border-[#cecece]  border-b-[1px] mt-2" >
            <p class=" underline font-bold " >Tareas</p>
            <p class="ml-6" >Lorem ipsum dolor, sit amet</p>
            <p class="ml-6" >Lorem ipsum dolor, sit amet</p>
            <p class="ml-6" >Lorem ipsum dolor, sit amet</p>
            <p class="ml-6" >Lorem ipsum dolor, sit amet</p>
            <p class="ml-6" >Lorem ipsum dolor, sit amet</p>
          ...
          <p class="text-justify border-[#cecece]   mt-2" >
            <p class=" underline font-bold " >Tipo de tareas</p>
    ...
    <ion-tabs>
      ...
      <ion-tab-bar #="bottom">
        <ion-tab-button tab="tab1" href="/tabs/tab1">
          <img :src="iconMap" class=" w-6 h-6" alt="">
          <ion-label>Cliente</ion-label>
        </ion-tab-button>
        <ion-tab-button tab="tab2" href="/tabs/tab2">
          <img :src="IconRepair" class=" w-6 h-6" />
...
import { IonTabBar, IonMenu, IonImg, IonMenuToggle, IonContent, IonToolbar, IonTitle, IonHeader, IonTabButton, IonTabs, IonLabel, IonIcon, IonPage, IonButton, IonRouterOutlet, menuController } from '@ionic/vue';
